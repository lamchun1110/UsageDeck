...
mod tests {
    ...
    fn background_console_process_has_no_console_window() {
        let script = r#"Add-Type -Name NativeMethods -Namespace UsageDeck -MemberDefinition '[System.Runtime.InteropServices.DllImport("kernel32.dll")] public static extern System.IntPtr GetConsoleWindow();'; [UsageDeck.NativeMethods]::GetConsoleWindow().ToInt64()"#;
